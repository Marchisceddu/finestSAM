...
if __name__ == "__main__":
    train_mask_path = "img/input/train_masks/"
    train_json_path = "img/input/train_images/train.json"
    process_masks(train_mask_path, train_json_path)

    # val_mask_path = "img/input/val_masks/"
    # val_json_path = "img/input/val_images/val.json"
