...
def display_image_with_annotations_yolo(image_path, annotation_path, colors=None):
...
image_path = "../../dataset/images/0.png" # AGGIUSTARE I PERCORSI
annotation_path = "../../dataset/yolo_annotations/0.txt"
